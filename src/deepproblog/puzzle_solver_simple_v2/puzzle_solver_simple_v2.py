...
from deepproblog.puzzle_solver_simple_v2.simple_puzzle_dataset import test_dataset, train_dataset
...
batch_size = 25
loader = DataLoader(train_dataset, batch_size, length=250)
...
model = Model("puzzle_solver_simple_v2.pl", [net, net2])
...
train = train_model(model, loader, 3, log_iter=1, profile=0)
