...
def get_triple_confusion_matrix(
    ...
    confusion_matrix3 = ConfusionMatrix()
    model.eval()
    ...
    for i, gt_query in enumerate(dataset.to_queries()):
        ...
        actual3 = str(gt_query.output_values()[2])
        if len(answer.result) == 0:
            predicted, predicted2,predicted3 = "no_answer", "no_answer","no_answer"
            if verbose > 1:
            ...
            if eps is None:
                ...
                predicted3 = str(max_ans.args[gt_query.output_ind[2]])
            else:
        ...
        confusion_matrix3.add_item(predicted3, actual3)
    ...
    if verbose > 0:
        ...
        print("Accuracy", confusion_matrix3.accuracy())

    return [confusion_matrix1, confusion_matrix2,confusion_matrix3]
