...
from deepproblog.puzzle_solver_simple_v3.simple_puzzle_dataset import test_dataset, train_dataset
...
net = Network(colour_net, "colour_net", batching=True)
net.optimizer = torch.optim.Adam(colour_net.parameters(), lr=1e-4)


#net.optimizer =torch.optim.SGD(puzzle_net.parameters(), lr=1e-3)


model = Model("puzzle_solver_simple_v3.pl", [net])
