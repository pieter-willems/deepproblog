...
from deepproblog.puzzle_solver_simple_v4.simple_puzzle_dataset import test_dataset, train_dataset
...
puzzle_net = smallnet(num_classes=4, pretrained=True)
